...
export default function DonorDashboardLayout({
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex" suppressHydrationWarning>
            {/* Sidebar Navigation */}
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex" suppressHydrationWarning>
                ...
                <nav className="flex-1 px-4 py-6 space-y-2" suppressHydrationWarning>
